...
Pessoa = definir_estrutura("Pessoa", "nome, cpf, telefone, endereco")
...
Coordenada = definir_estrutura("Coordenada", "x, y")
...
Musica = definir_estrutura("Musica", "titulo,artista,album,genero,duracao")
'''
